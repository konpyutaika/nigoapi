...
func (a *PoliciesApiService) RemoveAccessPolicy(ctx context.Context, version LongParameter, id string, localVarOptionals *PoliciesApiRemoveAccessPolicyOpts) (AccessPolicy, *http.Response, *string, error) {
	var (
...
@return AccessPolicy
*/
func (a *PoliciesApiService) UpdateAccessPolicy(ctx context.Context, body AccessPolicy, id string) (AccessPolicy, *http.Response, *string, error) {
	var (
