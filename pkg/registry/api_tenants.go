...
func (a *TenantsApiService) RemoveUser(ctx context.Context, version LongParameter, id string, localVarOptionals *TenantsApiRemoveUserOpts) (User, *http.Response, *string, error) {
	var (
...
func (a *TenantsApiService) RemoveUserGroup(ctx context.Context, version LongParameter, id string, localVarOptionals *TenantsApiRemoveUserGroupOpts) (UserGroup, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return User
*/
func (a *TenantsApiService) UpdateUser(ctx context.Context, body User, id string) (User, *http.Response, *string, error) {
	var (
...
@return UserGroup
*/
func (a *TenantsApiService) UpdateUserGroup(ctx context.Context, body UserGroup, id string) (UserGroup, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
