...
@return User
*/
func (a *TenantsApiService) CreateUser(ctx context.Context, body User) (User, *http.Response, error) {
	var (
...
@return UserGroup
*/
func (a *TenantsApiService) CreateUserGroup(ctx context.Context, body UserGroup) (UserGroup, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return User
*/
func (a *TenantsApiService) GetUser(ctx context.Context, id string) (User, *http.Response, error) {
	var (
...
@return UserGroup
*/
func (a *TenantsApiService) GetUserGroup(ctx context.Context, id string) (UserGroup, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return []UserGroup
*/
func (a *TenantsApiService) GetUserGroups(ctx context.Context) ([]UserGroup, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return []User
*/
func (a *TenantsApiService) GetUsers(ctx context.Context) ([]User, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *TenantsApiService) RemoveUser(ctx context.Context, version LongParameter, id string, localVarOptionals *TenantsApiRemoveUserOpts) (User, *http.Response, error) {
	var (
...
func (a *TenantsApiService) RemoveUserGroup(ctx context.Context, version LongParameter, id string, localVarOptionals *TenantsApiRemoveUserGroupOpts) (UserGroup, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return User
*/
func (a *TenantsApiService) UpdateUser(ctx context.Context, body User, id string) (User, *http.Response, error) {
	var (
...
@return UserGroup
*/
func (a *TenantsApiService) UpdateUserGroup(ctx context.Context, body UserGroup, id string) (UserGroup, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
