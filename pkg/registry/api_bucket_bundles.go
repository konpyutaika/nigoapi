...
func (a *BucketBundlesApiService) CreateExtensionBundleVersion(ctx context.Context, bucketId string, bundleType string, localVarOptionals *BucketBundlesApiCreateExtensionBundleVersionOpts) (BundleVersion, *http.Response, error) {
	var (
...
@return []Bundle
*/
func (a *BucketBundlesApiService) GetExtensionBundles(ctx context.Context, bucketId string) ([]Bundle, *http.Response, error) {
	var (
