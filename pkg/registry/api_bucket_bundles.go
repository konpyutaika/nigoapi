 ...
 * @param file The binary content of the bundle file being uploaded.
 * @param optional nil or *BucketBundlesApiCreateExtensionBundleVersionOpts - Optional Parameters:
     * @param "Sha256" (optional.String) -  Optional sha256 of the provided bundle

@return BundleVersion
*/

type BucketBundlesApiCreateExtensionBundleVersionOpts struct { 
	Sha256 optional.String
}

func (a *BucketBundlesApiService) CreateExtensionBundleVersion(ctx context.Context, bucketId string, bundleType string, file *os.File, localVarOptionals *BucketBundlesApiCreateExtensionBundleVersionOpts) (BundleVersion, *http.Response, *string, error) {
	var (
	...
	if localVarOptionals != nil && localVarOptionals.Sha256.IsSet() {
		localVarFormParams.Add("sha256", parameterToString(localVarOptionals.Sha256.Value(), ""))
	}
	if ctx != nil {
