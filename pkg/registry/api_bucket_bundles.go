...
*/
func (a *BucketBundlesApiService) CreateExtensionBundleVersion(ctx context.Context, bucketId string, bundleType string) (BundleVersion, *http.Response, error) {
	var (
...
*/
func (a *BucketBundlesApiService) GetExtensionBundles(ctx context.Context, bucketId string) ([]ExtensionBundle, *http.Response, error) {
	var (
