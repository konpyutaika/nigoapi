...
*/
func (a *FlowsApiService) GetFlow1(ctx context.Context, flowId string) (VersionedFlow, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *FlowsApiService) GetFlowVersion1(ctx context.Context, flowId string, versionNumber int32) (VersionedFlowSnapshot, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *FlowsApiService) GetFlowVersions1(ctx context.Context, flowId string) ([]VersionedFlowSnapshotMetadata, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return VersionedFlowSnapshot
*/
func (a *FlowsApiService) GetLatestFlowVersion1(ctx context.Context, flowId string) (VersionedFlowSnapshot, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return VersionedFlowSnapshotMetadata
*/
func (a *FlowsApiService) GetLatestFlowVersionMetadata1(ctx context.Context, flowId string) (VersionedFlowSnapshotMetadata, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
