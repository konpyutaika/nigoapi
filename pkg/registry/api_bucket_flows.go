...
func (a *BucketFlowsApiService) CreateFlowVersion(ctx context.Context, bucketId string, flowId string, body VersionedFlowSnapshot, localVarOptionals *BucketFlowsApiCreateFlowVersionOpts) (VersionedFlowSnapshot, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *BucketFlowsApiService) ImportVersionedFlow(ctx context.Context, bucketId string, flowId string, localVarOptionals *BucketFlowsApiImportVersionedFlowOpts) (VersionedFlowSnapshot, *http.Response, *string, error) {
	...
	if localVarOptionals != nil && localVarOptionals.Body.IsSet() {
		...
		localVarOptionalBody, localVarOptionalBodyok := localVarOptionals.Body.Value().(VersionedFlowSnapshot)
		if !localVarOptionalBodyok {
				return localVarReturnValue, nil, nil, reportError("body should be VersionedFlowSnapshot")
		}
