...
func (a *BucketsApiService) CreateBucket(ctx context.Context, body Bucket, localVarOptionals *BucketsApiCreateBucketOpts) (Bucket, *http.Response, error) {
	var (
...
func (a *BucketsApiService) DeleteBucket(ctx context.Context, version LongParameter, bucketId string, localVarOptionals *BucketsApiDeleteBucketOpts) (Bucket, *http.Response, error) {
	var (
...
@return Fields
*/
func (a *BucketsApiService) GetAvailableBucketFields(ctx context.Context) (Fields, *http.Response, error) {
	var (
...
@return Bucket
*/
func (a *BucketsApiService) GetBucket(ctx context.Context, bucketId string) (Bucket, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return []Bucket
*/
func (a *BucketsApiService) GetBuckets(ctx context.Context) ([]Bucket, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return Bucket
*/
func (a *BucketsApiService) UpdateBucket(ctx context.Context, body Bucket, bucketId string) (Bucket, *http.Response, error) {
	var (
