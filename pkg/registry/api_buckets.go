 ...
 * @param optional nil or *BucketsApiCreateBucketOpts - Optional Parameters:
     * @param "PreserveSourceProperties" (optional.Bool) -  Whether source properties like identifier should be kept
@return Bucket
*/
...
func (a *BucketsApiService) CreateBucket(ctx context.Context, body Bucket, localVarOptionals *BucketsApiCreateBucketOpts) (Bucket, *http.Response, *string, error) {
	var (
...
func (a *BucketsApiService) DeleteBucket(ctx context.Context, version LongParameter, bucketId string, localVarOptionals *BucketsApiDeleteBucketOpts) (Bucket, *http.Response, *string, error) {
	var (
...
@return Bucket
*/
func (a *BucketsApiService) UpdateBucket(ctx context.Context, body Bucket, bucketId string) (Bucket, *http.Response, *string, error) {
	var (
