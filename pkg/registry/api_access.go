...
*/
func (a *AccessApiService) CreateAccessTokenByTryingAllProviders(ctx context.Context) (*http.Response, error) {
	var (
...
*/
func (a *AccessApiService) CreateAccessTokenUsingBasicAuthCredentials(ctx context.Context) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *AccessApiService) CreateAccessTokenUsingIdentityProviderCredentials(ctx context.Context) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *AccessApiService) CreateAccessTokenUsingKerberosTicket(ctx context.Context) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return CurrentUser
*/
func (a *AccessApiService) GetAccessStatus(ctx context.Context) (CurrentUser, *http.Response, error) {
	var (
...
*/
func (a *AccessApiService) GetIdentityProviderUsageInstructions(ctx context.Context) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *AccessApiService) OidcExchange(ctx context.Context) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *AccessApiService) OidcLogoutCallback(ctx context.Context) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *AccessApiService) TestIdentityProviderRecognizesCredentialsFormat(ctx context.Context) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
