 ...
 * @param body The request to schedule or unschedule. If the components in the request are not specified, all authorized components will be considered.
 * @param id The process group id.
@return ActivateControllerServicesEntity
*/
func (a *FlowApiService) ActivateControllerServices(ctx context.Context, body ActivateControllerServicesEntity, id string) (ActivateControllerServicesEntity, *http.Response, *string, error) {
	var (
...
/*
FlowApiService Clears bulletins for components in the specified Process Group.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body The request to clear bulletins. If the components in the request are not specified, all authorized components will be considered.
 * @param id The process group id.
@return ClearBulletinsForGroupResultsEntity
*/
func (a *FlowApiService) ClearBulletins1(ctx context.Context, body ClearBulletinsForGroupRequestEntity, id string) (ClearBulletinsForGroupResultsEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ClearBulletinsForGroupResultsEntity
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/flow/process-groups/{id}/bulletins/clear-requests"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ClearBulletinsForGroupResultsEntity
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, &localStringBody, newErr
 ...
 * @param optional nil or *FlowApiDownloadReportingTaskSnapshotOpts - Optional Parameters:
     * @param "ReportingTaskId" (optional.String) -  Specifies a reporting task id to export. If not specified, all reporting tasks will be exported.
@return string
*/
...
func (a *FlowApiService) DownloadReportingTaskSnapshot(ctx context.Context, localVarOptionals *FlowApiDownloadReportingTaskSnapshotOpts) (string, *http.Response, *string, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/flow/reporting-tasks/download"

	localVarHeaderParams := make(map[string]string)
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}

	if localVarOptionals != nil && localVarOptionals.ReportingTaskId.IsSet() {
		localVarQueryParams.Add("reportingTaskId", parameterToString(localVarOptionals.ReportingTaskId.Value(), ""))
	}
	// to determine the Content-Type header
...
@return ActionEntity
*/
func (a *FlowApiService) GetAction(ctx context.Context, id IntegerParameter) (ActionEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
FlowApiService Retrieves the additional details for the specified component type.
Note: This endpoint is subject to change as NiFi and it&#x27;s REST API evolve.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param group The bundle group
 * @param artifact The bundle artifact
 * @param version The bundle version
 * @param type_ The processor type
@return AdditionalDetailsEntity
*/
func (a *FlowApiService) GetAdditionalDetails(ctx context.Context, group string, artifact string, version string, type_ string) (AdditionalDetailsEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue AdditionalDetailsEntity
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/flow/additional-details/{group}/{artifact}/{version}/{type}"
...
*/
func (a *FlowApiService) GetAllFlowAnalysisResults(ctx context.Context) (FlowAnalysisResultEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue FlowAnalysisResultEntity
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/flow/flow-analysis/results"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v FlowAnalysisResultEntity
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, &localStringBody, newErr
...
/*
FlowApiService Gets the branches from the specified registry for the current user
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id The registry id.
@return FlowRegistryBranchesEntity
*/
func (a *FlowApiService) GetBranches(ctx context.Context, id string) (FlowRegistryBranchesEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue FlowRegistryBranchesEntity
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/flow/registries/{id}/branches"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v FlowRegistryBranchesEntity
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, &localStringBody, newErr
...
*/
func (a *FlowApiService) GetBreadcrumbs(ctx context.Context, id string) (FlowBreadcrumbEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue FlowBreadcrumbEntity
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/flow/process-groups/{id}/breadcrumbs"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id The registry id.
 * @param optional nil or *FlowApiGetBucketsOpts - Optional Parameters:
     * @param "Branch" (optional.String) -  The name of a branch to get the buckets from. If not specified the default branch of the registry client will be used.
@return FlowRegistryBucketsEntity
*/

type FlowApiGetBucketsOpts struct {
    Branch optional.String
}

func (a *FlowApiService) GetBuckets(ctx context.Context, id string, localVarOptionals *FlowApiGetBucketsOpts) (FlowRegistryBucketsEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v FlowRegistryBucketsEntity
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, &localStringBody, newErr
 ...
 * @param optional nil or *FlowApiGetBulletinBoardOpts - Optional Parameters:
     * @param "After" (optional.Interface of LongParameter) -  Includes bulletins with an id after this value.
     * @param "SourceName" (optional.Interface of BulletinBoardPatternParameter) -  Includes bulletins originating from this sources whose name match this regular expression.
     * @param "Message" (optional.Interface of BulletinBoardPatternParameter) -  Includes bulletins whose message that match this regular expression.
     * @param "SourceId" (optional.Interface of BulletinBoardPatternParameter) -  Includes bulletins originating from this sources whose id match this regular expression.
     * @param "GroupId" (optional.Interface of BulletinBoardPatternParameter) -  Includes bulletins originating from this sources whose group id match this regular expression.
     * @param "Limit" (optional.Interface of IntegerParameter) -  The number of bulletins to limit the response to. Optional, default is no limit.
...
*/
func (a *FlowApiService) GetClusterSummary(ctx context.Context) (ClusterSummaryEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ClusterSummaryEntity
	)
...
/*
FlowApiService Retrieves the Connector Definition for the specified component type.
Note: This endpoint is subject to change as NiFi and it&#x27;s REST API evolve.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param group The bundle group
 * @param artifact The bundle artifact
 * @param version The bundle version
 * @param type_ The connector type
@return ConnectorDefinition
*/
func (a *FlowApiService) GetConnectorDefinition(ctx context.Context, group string, artifact string, version string, type_ string) (ConnectorDefinition, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ConnectorDefinition
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/flow/connector-definition/{group}/{artifact}/{version}/{type}"
	localVarPath = strings.Replace(localVarPath, "{"+"group"+"}", fmt.Sprintf("%v", group), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"artifact"+"}", fmt.Sprintf("%v", artifact), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"version"+"}", fmt.Sprintf("%v", version), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"type"+"}", fmt.Sprintf("%v", type_), -1)
...
/*
FlowApiService Retrieves the types of connectors that this NiFi supports
Note: This endpoint is subject to change as NiFi and it&#x27;s REST API evolve.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *FlowApiGetConnectorTypesOpts - Optional Parameters:
...
type FlowApiGetConnectorTypesOpts struct {
    BundleGroupFilter optional.String
    BundleArtifactFilter optional.String
    Type_ optional.String
}

func (a *FlowApiService) GetConnectorTypes(ctx context.Context, localVarOptionals *FlowApiGetConnectorTypesOpts) (ConnectorTypesEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ConnectorTypesEntity
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/flow/connector-types"
...
/*
FlowApiService Gets all connectors
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return ConnectorsEntity
*/
func (a *FlowApiService) GetConnectors(ctx context.Context) (ConnectorsEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ConnectorsEntity
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/flow/connectors"
...
/*
FlowApiService Retrieves the registered content viewers
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return ContentViewerEntity
*/
func (a *FlowApiService) GetContentViewers(ctx context.Context) (ContentViewerEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ContentViewerEntity
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/flow/content-viewers"
...
/*
FlowApiService Retrieves the Controller Service Definition for the specified component type.
Note: This endpoint is subject to change as NiFi and it&#x27;s REST API evolve.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param group The bundle group
 * @param artifact The bundle artifact
 * @param version The bundle version
 * @param type_ The controller service type
@return ControllerServiceDefinition
*/
func (a *FlowApiService) GetControllerServiceDefinition(ctx context.Context, group string, artifact string, version string, type_ string) (ControllerServiceDefinition, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ControllerServiceDefinition
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/flow/controller-service-definition/{group}/{artifact}/{version}/{type}"
	localVarPath = strings.Replace(localVarPath, "{"+"group"+"}", fmt.Sprintf("%v", group), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"artifact"+"}", fmt.Sprintf("%v", artifact), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"version"+"}", fmt.Sprintf("%v", version), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"type"+"}", fmt.Sprintf("%v", type_), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ControllerServiceDefinition
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, &localStringBody, newErr
...
func (a *FlowApiService) GetControllerServicesFromController(ctx context.Context, localVarOptionals *FlowApiGetControllerServicesFromControllerOpts) (ControllerServicesEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param optional nil or *FlowApiGetDetailsOpts - Optional Parameters:
     * @param "Branch" (optional.String) -  The name of a branch to get the flow from. If not specified the default branch of the registry client will be used.
@return VersionedFlowEntity
*/

type FlowApiGetDetailsOpts struct {
    Branch optional.String
}

func (a *FlowApiService) GetDetails(ctx context.Context, registryId string, bucketId string, flowId string, localVarOptionals *FlowApiGetDetailsOpts) (VersionedFlowEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/flow/registries/{registry-id}/buckets/{bucket-id}/flows/{flow-id}/details"
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id The process group id.
 * @param optional nil or *FlowApiGetFlow1Opts - Optional Parameters:
     * @param "UiOnly" (optional.Bool) - 
@return ProcessGroupFlowEntity
*/

type FlowApiGetFlow1Opts struct {
    UiOnly optional.Bool
}

func (a *FlowApiService) GetFlow1(ctx context.Context, id string, localVarOptionals *FlowApiGetFlow1Opts) (ProcessGroupFlowEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return FlowAnalysisResultEntity
*/
func (a *FlowApiService) GetFlowAnalysisResults(ctx context.Context, processGroupId string) (FlowAnalysisResultEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/flow/flow-analysis/results/{processGroupId}"
...
/*
FlowApiService Retrieves the Flow Analysis Rule Definition for the specified component type.
Note: This endpoint is subject to change as NiFi and it&#x27;s REST API evolve.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param group The bundle group
 * @param artifact The bundle artifact
 * @param version The bundle version
 * @param type_ The flow analysis rule type
@return FlowAnalysisRuleDefinition
*/
func (a *FlowApiService) GetFlowAnalysisRuleDefinition(ctx context.Context, group string, artifact string, version string, type_ string) (FlowAnalysisRuleDefinition, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue FlowAnalysisRuleDefinition
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/flow/flow-analysis-rule-definition/{group}/{artifact}/{version}/{type}"
	localVarPath = strings.Replace(localVarPath, "{"+"group"+"}", fmt.Sprintf("%v", group), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"artifact"+"}", fmt.Sprintf("%v", artifact), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"version"+"}", fmt.Sprintf("%v", version), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"type"+"}", fmt.Sprintf("%v", type_), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v FlowAnalysisRuleDefinition
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, &localStringBody, newErr
...
Note: This endpoint is subject to change as NiFi and it&#x27;s REST API evolve.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *FlowApiGetFlowAnalysisRuleTypesOpts - Optional Parameters:
     * @param "BundleGroupFilter" (optional.String) -  If specified, will only return types that are a member of this bundle group.
     * @param "BundleArtifactFilter" (optional.String) -  If specified, will only return types that are a member of this bundle artifact.
     * @param "Type_" (optional.String) -  If specified, will only return types whose fully qualified classname matches.
...
func (a *FlowApiService) GetFlowAnalysisRuleTypes(ctx context.Context, localVarOptionals *FlowApiGetFlowAnalysisRuleTypesOpts) (FlowAnalysisRuleTypesEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue FlowAnalysisRuleTypesEntity
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/flow/flow-analysis-rule-types"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v FlowAnalysisRuleTypesEntity
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, &localStringBody, newErr
 ...
 * @param optional nil or *FlowApiGetFlowMetricsOpts - Optional Parameters:
     * @param "IncludedRegistries" (optional.String) -  Set of included metrics registries. Duplicate the parameter to include multiple registries. All registries are included by default.
     ...
     * @param "FlowMetricsReportingStrategy" (optional.String) -  Flow metrics reporting strategy limits collected metrics
@return StreamingOutput
*/

type FlowApiGetFlowMetricsOpts struct {
    IncludedRegistries optional.String
    SampleName optional.String
    SampleLabelValue optional.String
    RootFieldName optional.String
    FlowMetricsReportingStrategy optional.String
}

func (a *FlowApiService) GetFlowMetrics(ctx context.Context, producer string, localVarOptionals *FlowApiGetFlowMetricsOpts) (StreamingOutput, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	if localVarOptionals != nil && localVarOptionals.IncludedRegistries.IsSet() {
		localVarQueryParams.Add("includedRegistries", parameterToString(localVarOptionals.IncludedRegistries.Value(), ""))
	}
	...
	if localVarOptionals != nil && localVarOptionals.FlowMetricsReportingStrategy.IsSet() {
		localVarQueryParams.Add("flowMetricsReportingStrategy", parameterToString(localVarOptionals.FlowMetricsReportingStrategy.Value(), ""))
	}
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{}
...
/*
FlowApiService Retrieves the Flow Registry Client Definition for the specified component type.
Note: This endpoint is subject to change as NiFi and it&#x27;s REST API evolve.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param group The bundle group
 * @param artifact The bundle artifact
 * @param version The bundle version
 * @param type_ The flow registry client type
@return FlowRegistryClientDefinition
*/
func (a *FlowApiService) GetFlowRegistryClientDefinition(ctx context.Context, group string, artifact string, version string, type_ string) (FlowRegistryClientDefinition, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue FlowRegistryClientDefinition
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/flow/flow-registry-client-definition/{group}/{artifact}/{version}/{type}"
	localVarPath = strings.Replace(localVarPath, "{"+"group"+"}", fmt.Sprintf("%v", group), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"artifact"+"}", fmt.Sprintf("%v", artifact), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"version"+"}", fmt.Sprintf("%v", version), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"type"+"}", fmt.Sprintf("%v", type_), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v FlowRegistryClientDefinition
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, &localStringBody, newErr
 ...
 * @param registryId The registry client id.
 * @param bucketId The bucket id.
 * @param optional nil or *FlowApiGetFlowsOpts - Optional Parameters:
     * @param "Branch" (optional.String) -  The name of a branch to get the flows from. If not specified the default branch of the registry client will be used.
@return VersionedFlowsEntity
*/

type FlowApiGetFlowsOpts struct {
    Branch optional.String
}

func (a *FlowApiService) GetFlows(ctx context.Context, registryId string, bucketId string, localVarOptionals *FlowApiGetFlowsOpts) (VersionedFlowsEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
FlowApiService Gets all listen ports configured on this NiFi that the current user has access to
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return ListenPortsEntity
*/
func (a *FlowApiService) GetListenPorts(ctx context.Context) (ListenPortsEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ListenPortsEntity
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/flow/listen-ports"
...
/*
FlowApiService Retrieves the Parameter Provider Definition for the specified component type.
Note: This endpoint is subject to change as NiFi and it&#x27;s REST API evolve.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param group The bundle group
 * @param artifact The bundle artifact
 * @param version The bundle version
 * @param type_ The parameter provider type
@return ParameterProviderDefinition
*/
func (a *FlowApiService) GetParameterProviderDefinition(ctx context.Context, group string, artifact string, version string, type_ string) (ParameterProviderDefinition, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ParameterProviderDefinition
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/flow/parameter-provider-definition/{group}/{artifact}/{version}/{type}"
	localVarPath = strings.Replace(localVarPath, "{"+"group"+"}", fmt.Sprintf("%v", group), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"artifact"+"}", fmt.Sprintf("%v", artifact), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"version"+"}", fmt.Sprintf("%v", version), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"type"+"}", fmt.Sprintf("%v", type_), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ParameterProviderDefinition
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, &localStringBody, newErr
...
Note: This endpoint is subject to change as NiFi and it&#x27;s REST API evolve.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *FlowApiGetParameterProviderTypesOpts - Optional Parameters:
     * @param "BundleGroupFilter" (optional.String) -  If specified, will only return types that are a member of this bundle group.
     * @param "BundleArtifactFilter" (optional.String) -  If specified, will only return types that are a member of this bundle artifact.
     * @param "Type_" (optional.String) -  If specified, will only return types whose fully qualified classname matches.
...
func (a *FlowApiService) GetParameterProviderTypes(ctx context.Context, localVarOptionals *FlowApiGetParameterProviderTypesOpts) (ParameterProviderTypesEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/flow/parameter-provider-types"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ParameterProviderTypesEntity
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, &localStringBody, newErr
...
*/
func (a *FlowApiService) GetParameterProviders(ctx context.Context) (ParameterProvidersEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/flow/parameter-providers"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v ParameterProvidersEntity
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, &localStringBody, newErr
...
/*
FlowApiService Retrieves the Processor Definition for the specified component type.
Note: This endpoint is subject to change as NiFi and it&#x27;s REST API evolve.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param group The bundle group
 * @param artifact The bundle artifact
...
*/
func (a *FlowApiService) GetProcessorDefinition(ctx context.Context, group string, artifact string, version string, type_ string) (ProcessorDefinition, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ProcessorDefinition
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/flow/processor-definition/{group}/{artifact}/{version}/{type}"
	localVarPath = strings.Replace(localVarPath, "{"+"group"+"}", fmt.Sprintf("%v", group), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"artifact"+"}", fmt.Sprintf("%v", artifact), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"version"+"}", fmt.Sprintf("%v", version), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"type"+"}", fmt.Sprintf("%v", type_), -1)
...
*/
func (a *FlowApiService) GetRegistryClients(ctx context.Context) (FlowRegistryClientsEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
FlowApiService Retrieves the Reporting Task Definition for the specified component type.
Note: This endpoint is subject to change as NiFi and it&#x27;s REST API evolve.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param group The bundle group
 * @param artifact The bundle artifact
 * @param version The bundle version
 * @param type_ The reporting task type
@return ReportingTaskDefinition
*/
func (a *FlowApiService) GetReportingTaskDefinition(ctx context.Context, group string, artifact string, version string, type_ string) (ReportingTaskDefinition, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ReportingTaskDefinition
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/flow/reporting-task-definition/{group}/{artifact}/{version}/{type}"
	localVarPath = strings.Replace(localVarPath, "{"+"group"+"}", fmt.Sprintf("%v", group), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"artifact"+"}", fmt.Sprintf("%v", artifact), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"version"+"}", fmt.Sprintf("%v", version), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"type"+"}", fmt.Sprintf("%v", type_), -1)
...
func (a *FlowApiService) GetReportingTaskSnapshot(ctx context.Context, localVarOptionals *FlowApiGetReportingTaskSnapshotOpts) (VersionedReportingTaskSnapshot, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue VersionedReportingTaskSnapshot
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/flow/reporting-tasks/snapshot"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v VersionedReportingTaskSnapshot
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, &localStringBody, newErr
...
*/
func (a *FlowApiService) GetRuntimeManifest(ctx context.Context) (RuntimeManifestEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
FlowApiService Retrieves the step documentation for the specified Connector configuration step.
Note: This endpoint is subject to change as NiFi and it&#x27;s REST API evolve.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param group The bundle group
 * @param artifact The bundle artifact
 * @param version The bundle version
 * @param connectorType The fully qualified Connector type
 * @param stepName The configuration step name
@return StepDocumentationEntity
*/
func (a *FlowApiService) GetStepDocumentation(ctx context.Context, group string, artifact string, version string, connectorType string, stepName string) (StepDocumentationEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue StepDocumentationEntity
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/flow/steps/{group}/{artifact}/{version}/{connectorType}/{stepName}"
	localVarPath = strings.Replace(localVarPath, "{"+"group"+"}", fmt.Sprintf("%v", group), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"artifact"+"}", fmt.Sprintf("%v", artifact), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"version"+"}", fmt.Sprintf("%v", version), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"connectorType"+"}", fmt.Sprintf("%v", connectorType), -1)
...
/*
FlowApiService Gets the differences between two versions of the same versioned flow, the basis of the comparison will be the first version
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param registryId The registry client id.
 * @param branchIdA The branch id for the base version.
 * @param bucketIdA The bucket id for the base version.
 * @param flowIdA The flow id for the base version.
 * @param versionA The base version.
 * @param branchIdB The branch id for the compared version.
 * @param bucketIdB The bucket id for the compared version.
 * @param flowIdB The flow id for the compared version.
 * @param versionB The compared version.
 * @param optional nil or *FlowApiGetVersionDifferencesOpts - Optional Parameters:
     * @param "Offset" (optional.Int32) -  Must be a non-negative number. Specifies the starting point of the listing. 0 means start from the beginning.
     * @param "Limit" (optional.Int32) -  Limits the number of differences listed. This might lead to partial result. 0 means no limitation is applied.
@return FlowComparisonEntity
*/

type FlowApiGetVersionDifferencesOpts struct {
    Offset optional.Int32
    Limit optional.Int32
}

func (a *FlowApiService) GetVersionDifferences(ctx context.Context, registryId string, branchIdA string, bucketIdA string, flowIdA string, versionA string, branchIdB string, bucketIdB string, flowIdB string, versionB string, localVarOptionals *FlowApiGetVersionDifferencesOpts) (FlowComparisonEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/flow/registries/{registry-id}/branches/{branch-id-a}/buckets/{bucket-id-a}/flows/{flow-id-a}/{version-a}/diff/branches/{branch-id-b}/buckets/{bucket-id-b}/flows/{flow-id-b}/{version-b}"
	localVarPath = strings.Replace(localVarPath, "{"+"registry-id"+"}", fmt.Sprintf("%v", registryId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"branch-id-a"+"}", fmt.Sprintf("%v", branchIdA), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"bucket-id-a"+"}", fmt.Sprintf("%v", bucketIdA), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"flow-id-a"+"}", fmt.Sprintf("%v", flowIdA), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"version-a"+"}", fmt.Sprintf("%v", versionA), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"branch-id-b"+"}", fmt.Sprintf("%v", branchIdB), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"bucket-id-b"+"}", fmt.Sprintf("%v", bucketIdB), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"flow-id-b"+"}", fmt.Sprintf("%v", flowIdB), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"version-b"+"}", fmt.Sprintf("%v", versionB), -1)
 ...
 * @param bucketId The bucket id.
 * @param flowId The flow id.
 * @param optional nil or *FlowApiGetVersionsOpts - Optional Parameters:
     * @param "Branch" (optional.String) -  The name of a branch to get the flow versions from. If not specified the default branch of the registry client will be used.
@return VersionedFlowSnapshotMetadataSetEntity
*/

type FlowApiGetVersionsOpts struct {
    Branch optional.String
}

func (a *FlowApiService) GetVersions(ctx context.Context, registryId string, bucketId string, flowId string, localVarOptionals *FlowApiGetVersionsOpts) (VersionedFlowSnapshotMetadataSetEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param optional nil or *FlowApiQueryHistoryOpts - Optional Parameters:
     ...
     * @param "StartDate" (optional.Interface of DateTimeParameter) -  Include actions after this date.
     * @param "EndDate" (optional.Interface of DateTimeParameter) -  Include actions before this date.
...
func (a *FlowApiService) QueryHistory(ctx context.Context, offset IntegerParameter, count IntegerParameter, localVarOptionals *FlowApiQueryHistoryOpts) (HistoryEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *FlowApiService) ScheduleComponents(ctx context.Context, body ScheduleComponentsEntity, id string) (ScheduleComponentsEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param optional nil or *FlowApiSearchFlowOpts - Optional Parameters:
     ...
     * @param "A" (optional.String) -  The id of the currently visited process group. If not specified, then the root process group is used.
