 ...
 * @param optional nil or *FlowApiGetBulletinBoardOpts - Optional Parameters:
     ...
     * @param "Limit" (optional.Interface of IntegerParameter) -  The number of bulletins to limit the response to.
...
func (a *FlowApiService) GetFlow(ctx context.Context, id string, localVarOptionals *FlowApiGetFlowOpts) (ProcessGroupFlowEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
