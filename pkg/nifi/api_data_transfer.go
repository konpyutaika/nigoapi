 ...
 * @param optional nil or *DataTransferApiCommitInputPortTransactionOpts - Optional Parameters:
...
func (a *DataTransferApiService) CommitInputPortTransaction(ctx context.Context, responseCode int32, portId string, transactionId string, localVarOptionals *DataTransferApiCommitInputPortTransactionOpts) (TransactionResultEntity, *http.Response, *string, error) {
	var (
 ...
 * @param transactionId The transaction id.
 * @param optional nil or *DataTransferApiCommitOutputPortTransactionOpts - Optional Parameters:
     * @param "Body" (optional.Interface of interface{}) - 
@return TransactionResultEntity
*/
...
func (a *DataTransferApiService) CommitOutputPortTransaction(ctx context.Context, responseCode int32, checksum string, portId string, transactionId string, localVarOptionals *DataTransferApiCommitOutputPortTransactionOpts) (TransactionResultEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param portId The input or output port id.
 * @param optional nil or *DataTransferApiCreatePortTransactionOpts - Optional Parameters:
     * @param "Body" (optional.Interface of interface{}) - 
@return TransactionResultEntity
*/
...
func (a *DataTransferApiService) CreatePortTransaction(ctx context.Context, portType string, portId string, localVarOptionals *DataTransferApiCreatePortTransactionOpts) (TransactionResultEntity, *http.Response, *string, error) {
	var (
 ...
 * @param portId The input port id.
 * @param transactionId The transaction id.
 * @param optional nil or *DataTransferApiExtendInputPortTransactionTTLOpts - Optional Parameters:
     * @param "Body" (optional.Interface of interface{}) - 
@return TransactionResultEntity
*/
...
func (a *DataTransferApiService) ExtendInputPortTransactionTTL(ctx context.Context, portId string, transactionId string, localVarOptionals *DataTransferApiExtendInputPortTransactionTTLOpts) (TransactionResultEntity, *http.Response, *string, error) {
	var (
 ...
 * @param portId The output port id.
 * @param transactionId The transaction id.
 * @param optional nil or *DataTransferApiExtendOutputPortTransactionTTLOpts - Optional Parameters:
     * @param "Body" (optional.Interface of interface{}) - 
@return TransactionResultEntity
*/
...
func (a *DataTransferApiService) ExtendOutputPortTransactionTTL(ctx context.Context, portId string, transactionId string, localVarOptionals *DataTransferApiExtendOutputPortTransactionTTLOpts) (TransactionResultEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
DataTransferApiService Transfer FlowFiles to the input port
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param portId The input port id.
 * @param transactionId The transaction id.
 * @param optional nil or *DataTransferApiReceiveFlowFilesOpts - Optional Parameters:
     * @param "Body" (optional.Interface of interface{}) - 
@return string
*/
...
func (a *DataTransferApiService) ReceiveFlowFiles(ctx context.Context, portId string, transactionId string, localVarOptionals *DataTransferApiReceiveFlowFilesOpts) (string, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
/*
DataTransferApiService Transfer FlowFiles from the output port
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param portId The output port id.
 * @param transactionId The transaction id.
