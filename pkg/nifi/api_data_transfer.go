...
func (a *DataTransferApiService) CommitInputPortTransaction(ctx context.Context, responseCode int32, portId string, transactionId string, localVarOptionals *DataTransferApiCommitInputPortTransactionOpts) (TransactionResultEntity, *http.Response, error) {
	var (
...
func (a *DataTransferApiService) CommitOutputPortTransaction(ctx context.Context, responseCode int32, checksum string, portId string, transactionId string, localVarOptionals *DataTransferApiCommitOutputPortTransactionOpts) (TransactionResultEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *DataTransferApiService) CreatePortTransaction(ctx context.Context, portType string, portId string, localVarOptionals *DataTransferApiCreatePortTransactionOpts) (TransactionResultEntity, *http.Response, error) {
	var (
...
func (a *DataTransferApiService) ExtendInputPortTransactionTTL(ctx context.Context, portId string, transactionId string, localVarOptionals *DataTransferApiExtendInputPortTransactionTTLOpts) (TransactionResultEntity, *http.Response, error) {
	var (
...
func (a *DataTransferApiService) ExtendOutputPortTransactionTTL(ctx context.Context, portId string, transactionId string, localVarOptionals *DataTransferApiExtendOutputPortTransactionTTLOpts) (TransactionResultEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *DataTransferApiService) ReceiveFlowFiles(ctx context.Context, portId string, transactionId string, localVarOptionals *DataTransferApiReceiveFlowFilesOpts) (string, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *DataTransferApiService) TransferFlowFiles(ctx context.Context, portId string, transactionId string, localVarOptionals *DataTransferApiTransferFlowFilesOpts) (*http.Response, error) {
	var (
