...
*/
func (a *ProcessorsApiService) AnalyzeConfiguration2(ctx context.Context, body ConfigurationAnalysisEntity, id string) (ConfigurationAnalysisEntity, *http.Response, *string, error) {
	var (
...
/*
ProcessorsApiService Clears bulletins for a processor
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
*/
func (a *ProcessorsApiService) ClearBulletins5(ctx context.Context, body ClearBulletinsRequestEntity, id string) (ClearBulletinsResultEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/processors/{id}/bulletins/clear-requests"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id The processor id.
 * @param optional nil or *ProcessorsApiClearState3Opts - Optional Parameters:
...
type ProcessorsApiClearState3Opts struct {
    Body optional.Interface
}

func (a *ProcessorsApiService) ClearState3(ctx context.Context, id string, localVarOptionals *ProcessorsApiClearState3Opts) (ComponentStateEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *ProcessorsApiService) DeleteVerificationRequest2(ctx context.Context, id string, requestId string) (VerifyConfigRequestEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *ProcessorsApiService) GetPropertyDescriptor3(ctx context.Context, id string, propertyName string, localVarOptionals *ProcessorsApiGetPropertyDescriptor3Opts) (PropertyDescriptorEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return ComponentStateEntity
*/
func (a *ProcessorsApiService) GetState2(ctx context.Context, id string) (ComponentStateEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return VerifyConfigRequestEntity
*/
func (a *ProcessorsApiService) GetVerificationRequest2(ctx context.Context, id string, requestId string) (VerifyConfigRequestEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return VerifyConfigRequestEntity
*/
func (a *ProcessorsApiService) SubmitProcessorVerificationRequest(ctx context.Context, body VerifyConfigRequestEntity, id string) (VerifyConfigRequestEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return ProcessorEntity
*/
func (a *ProcessorsApiService) UpdateProcessor(ctx context.Context, body ProcessorEntity, id string) (ProcessorEntity, *http.Response, *string, error) {
	var (
...
@return ProcessorEntity
*/
func (a *ProcessorsApiService) UpdateRunStatus4(ctx context.Context, body ProcessorRunStatusEntity, id string) (ProcessorEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
