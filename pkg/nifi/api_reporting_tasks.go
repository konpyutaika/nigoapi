...
*/
func (a *ReportingTasksApiService) AnalyzeConfiguration(ctx context.Context, id string, body ConfigurationAnalysisEntity) (ConfigurationAnalysisEntity, *http.Response, *string, error) {
	var (
...
*/
func (a *ReportingTasksApiService) DeleteVerificationRequest(ctx context.Context, id string, requestId string) (VerifyConfigRequestEntity, *http.Response, *string, error) {
	var (
...
func (a *ReportingTasksApiService) GetPropertyDescriptor(ctx context.Context, id string, propertyName string, localVarOptionals *ReportingTasksApiGetPropertyDescriptorOpts) (PropertyDescriptorEntity, *http.Response, *string, error) {
	var (
...
@return VerifyConfigRequestEntity
*/
func (a *ReportingTasksApiService) GetVerificationRequest(ctx context.Context, id string, requestId string) (VerifyConfigRequestEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return VerifyConfigRequestEntity
*/
func (a *ReportingTasksApiService) SubmitConfigVerificationRequest(ctx context.Context, id string, body VerifyConfigRequestEntity) (VerifyConfigRequestEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
