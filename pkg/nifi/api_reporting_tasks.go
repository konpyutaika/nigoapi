...
*/
func (a *ReportingTasksApiService) AnalyzeConfiguration3(ctx context.Context, body ConfigurationAnalysisEntity, id string) (ConfigurationAnalysisEntity, *http.Response, error) {
	var (
...
*/
func (a *ReportingTasksApiService) ClearState4(ctx context.Context, id string) (ComponentStateEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *ReportingTasksApiService) DeleteVerificationRequest3(ctx context.Context, id string, requestId string) (VerifyConfigRequestEntity, *http.Response, error) {
	var (
...
func (a *ReportingTasksApiService) GetPropertyDescriptor4(ctx context.Context, id string, propertyName string, localVarOptionals *ReportingTasksApiGetPropertyDescriptor4Opts) (PropertyDescriptorEntity, *http.Response, error) {
	var (
...
@return ComponentStateEntity
*/
func (a *ReportingTasksApiService) GetState4(ctx context.Context, id string) (ComponentStateEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return VerifyConfigRequestEntity
*/
func (a *ReportingTasksApiService) GetVerificationRequest3(ctx context.Context, id string, requestId string) (VerifyConfigRequestEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return VerifyConfigRequestEntity
*/
func (a *ReportingTasksApiService) SubmitConfigVerificationRequest2(ctx context.Context, body VerifyConfigRequestEntity, id string) (VerifyConfigRequestEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return ReportingTaskEntity
*/
func (a *ReportingTasksApiService) UpdateRunStatus5(ctx context.Context, body ReportingTaskRunStatusEntity, id string) (ReportingTaskEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
