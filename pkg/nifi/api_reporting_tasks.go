...
/*
ReportingTasksApiService Clears bulletins for a reporting task
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
*/
func (a *ReportingTasksApiService) ClearBulletins7(ctx context.Context, body ClearBulletinsRequestEntity, id string) (ClearBulletinsResultEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/reporting-tasks/{id}/bulletins/clear-requests"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id The reporting task id.
 * @param optional nil or *ReportingTasksApiClearState4Opts - Optional Parameters:
...
type ReportingTasksApiClearState4Opts struct {
    Body optional.Interface
}

func (a *ReportingTasksApiService) ClearState4(ctx context.Context, id string, localVarOptionals *ReportingTasksApiClearState4Opts) (ComponentStateEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return ReportingTaskEntity
*/
func (a *ReportingTasksApiService) UpdateRunStatus6(ctx context.Context, body ReportingTaskRunStatusEntity, id string) (ReportingTaskEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
