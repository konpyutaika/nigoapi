...
*/
func (a *ControllerServicesApiService) DeleteValidationRequest(ctx context.Context, id string, requestId string) (VerifyConfigRequestEntity, *http.Response, *string, error) {
	var (
