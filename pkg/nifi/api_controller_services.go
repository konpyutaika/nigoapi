...
*/
func (a *ControllerServicesApiService) AnalyzeConfiguration(ctx context.Context, body ConfigurationAnalysisEntity, id string) (ConfigurationAnalysisEntity, *http.Response, *string, error) {
	var (
...
/*
ControllerServicesApiService Clears bulletins for a controller service
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
...
*/
func (a *ControllerServicesApiService) ClearBulletins(ctx context.Context, body ClearBulletinsRequestEntity, id string) (ClearBulletinsResultEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/controller-services/{id}/bulletins/clear-requests"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id The controller service id.
 * @param optional nil or *ControllerServicesApiClearState1Opts - Optional Parameters:
...
type ControllerServicesApiClearState1Opts struct {
    Body optional.Interface
}

func (a *ControllerServicesApiService) ClearState1(ctx context.Context, id string, localVarOptionals *ControllerServicesApiClearState1Opts) (ComponentStateEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *ControllerServicesApiService) DeleteVerificationRequest(ctx context.Context, id string, requestId string) (VerifyConfigRequestEntity, *http.Response, *string, error) {
	var (
...
func (a *ControllerServicesApiService) GetControllerService(ctx context.Context, id string, localVarOptionals *ControllerServicesApiGetControllerServiceOpts) (ControllerServiceEntity, *http.Response, *string, error) {
	var (
...
func (a *ControllerServicesApiService) GetPropertyDescriptor1(ctx context.Context, id string, propertyName string, localVarOptionals *ControllerServicesApiGetPropertyDescriptor1Opts) (PropertyDescriptorEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return VerifyConfigRequestEntity
*/
func (a *ControllerServicesApiService) GetVerificationRequest(ctx context.Context, id string, requestId string) (VerifyConfigRequestEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return VerifyConfigRequestEntity
*/
func (a *ControllerServicesApiService) SubmitConfigVerificationRequest(ctx context.Context, body VerifyConfigRequestEntity, id string) (VerifyConfigRequestEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return ControllerServiceEntity
*/
func (a *ControllerServicesApiService) UpdateControllerService(ctx context.Context, body ControllerServiceEntity, id string) (ControllerServiceEntity, *http.Response, *string, error) {
	var (
...
@return ControllerServiceReferencingComponentsEntity
*/
func (a *ControllerServicesApiService) UpdateControllerServiceReferences(ctx context.Context, body UpdateControllerServiceReferenceRequestEntity, id string) (ControllerServiceReferencingComponentsEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return ControllerServiceEntity
*/
func (a *ControllerServicesApiService) UpdateRunStatus2(ctx context.Context, body ControllerServiceRunStatusEntity, id string) (ControllerServiceEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
