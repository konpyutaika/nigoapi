...
@return ControllerServiceEntity
*/
func (a *ControllerServicesApiService) UpdateRunStatus1(ctx context.Context, body ControllerServiceRunStatusEntity, id string) (ControllerServiceEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
