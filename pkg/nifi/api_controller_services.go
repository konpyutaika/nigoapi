...
*/
func (a *ControllerServicesApiService) AnalyzeConfiguration(ctx context.Context, id string, body ConfigurationAnalysisEntity) (ConfigurationAnalysisEntity, *http.Response, *string, error) {
	var (
...
func (a *ControllerServicesApiService) GetPropertyDescriptor(ctx context.Context, id string, propertyName string, localVarOptionals *ControllerServicesApiGetPropertyDescriptorOpts) (PropertyDescriptorEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return VerifyConfigRequestEntity
*/
func (a *ControllerServicesApiService) SubmitConfigVerificationRequest(ctx context.Context, id string, body VerifyConfigRequestEntity) (VerifyConfigRequestEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
