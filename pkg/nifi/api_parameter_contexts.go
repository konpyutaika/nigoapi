...
/*
ParameterContextsApiService Creates a new Asset in the given Parameter Context
 ...
 * @param contextId
 * @param optional nil or *ParameterContextsApiCreateAssetOpts - Optional Parameters:
     * @param "Filename" (optional.String) - 
@return AssetEntity
*/

type ParameterContextsApiCreateAssetOpts struct {
    Filename optional.String
}

func (a *ParameterContextsApiService) CreateAsset(ctx context.Context, body interface{}, contextId string, localVarOptionals *ParameterContextsApiCreateAssetOpts) (AssetEntity, *http.Response, *string, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/parameter-contexts/{contextId}/assets"
...
/*
ParameterContextsApiService Deletes an Asset from the given Parameter Context
This endpoint will create a new Asset in the given Parameter Context. The Asset will be created with the given name and the contents of the file that is uploaded. The Asset will be created in the given Parameter Context, and will be available for use by any component that references the Parameter Context.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param contextId The ID of the Parameter Context
 * @param assetId The ID of the Asset
 * @param optional nil or *ParameterContextsApiDeleteAssetOpts - Optional Parameters:
     * @param "DisconnectedNodeAcknowledged" (optional.Bool) - 
@return AssetEntity
*/

type ParameterContextsApiDeleteAssetOpts struct {
    DisconnectedNodeAcknowledged optional.Bool
}

func (a *ParameterContextsApiService) DeleteAsset(ctx context.Context, contextId string, assetId string, localVarOptionals *ParameterContextsApiDeleteAssetOpts) (AssetEntity, *http.Response, *string, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/parameter-contexts/{contextId}/assets/{assetId}"
	localVarPath = strings.Replace(localVarPath, "{"+"contextId"+"}", fmt.Sprintf("%v", contextId), -1)
 ...
 * @param optional nil or *ParameterContextsApiDeleteParameterContextOpts - Optional Parameters:
     * @param "Version" (optional.Interface of LongParameter) -  The version is used to verify the client is working with the latest version of the flow.
     * @param "ClientId" (optional.Interface of ClientIdParameter) -  If the client id is not specified, a new one will be generated. This value (whether specified or generated) is included in the response.
...
/*
ParameterContextsApiService Retrieves the content of the asset with the given id
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param contextId The ID of the Parameter Context
 * @param assetId The ID of the Asset
@return string
*/
func (a *ParameterContextsApiService) GetAssetContent(ctx context.Context, contextId string, assetId string) (string, *http.Response, *string, error) {
	var (
...
/*
ParameterContextsApiService Lists the assets that belong to the Parameter Context with the given ID
Lists the assets that belong to the Parameter Context with the given ID.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param contextId The ID of the Parameter Context
@return AssetsEntity
*/
func (a *ParameterContextsApiService) GetAssets(ctx context.Context, contextId string) (AssetsEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *ParameterContextsApiService) GetParameterContext(ctx context.Context, id string, localVarOptionals *ParameterContextsApiGetParameterContextOpts) (ParameterContextEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return ParameterContextUpdateRequestEntity
*/
func (a *ParameterContextsApiService) SubmitParameterContextUpdate(ctx context.Context, body ParameterContextEntity, contextId string) (ParameterContextUpdateRequestEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return ParameterContextValidationRequestEntity
*/
func (a *ParameterContextsApiService) SubmitValidationRequest(ctx context.Context, body ParameterContextValidationRequestEntity, contextId string) (ParameterContextValidationRequestEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return ParameterContextEntity
*/
func (a *ParameterContextsApiService) UpdateParameterContext(ctx context.Context, body ParameterContextEntity, id string) (ParameterContextEntity, *http.Response, *string, error) {
	var (
