 ...
 * @param contextId
 * @param optional nil or *ParameterContextsApiCreateAsset1Opts - Optional Parameters:
     * @param "Filename" (optional.String) - 
@return AssetEntity
*/

type ParameterContextsApiCreateAsset1Opts struct {
    Filename optional.String
}

func (a *ParameterContextsApiService) CreateAsset1(ctx context.Context, body interface{}, contextId string, localVarOptionals *ParameterContextsApiCreateAsset1Opts) (AssetEntity, *http.Response, *string, error) {
	var (
...
@return string
*/
func (a *ParameterContextsApiService) GetAssetContent1(ctx context.Context, contextId string, assetId string) (string, *http.Response, *string, error) {
	var (
...
@return AssetsEntity
*/
func (a *ParameterContextsApiService) GetAssets1(ctx context.Context, contextId string) (AssetsEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
