...
func (a *ProvenanceEventsApiService) GetInputContent(ctx context.Context, id LongParameter, localVarOptionals *ProvenanceEventsApiGetInputContentOpts) (StreamingOutput, *http.Response, error) {
	var (
...
func (a *ProvenanceEventsApiService) GetOutputContent(ctx context.Context, id LongParameter, localVarOptionals *ProvenanceEventsApiGetOutputContentOpts) (StreamingOutput, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *ProvenanceEventsApiService) GetProvenanceEvent(ctx context.Context, id LongParameter, localVarOptionals *ProvenanceEventsApiGetProvenanceEventOpts) (ProvenanceEventEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *ProvenanceEventsApiService) SubmitReplayLatestEvent(ctx context.Context, body ReplayLastEventRequestEntity) (ReplayLastEventResponseEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
