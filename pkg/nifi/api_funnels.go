...
@return FunnelEntity
*/
func (a *FunnelsApiService) GetFunnel(ctx context.Context, id string) (FunnelEntity, *http.Response, *string, error) {
	var (
...
func (a *FunnelsApiService) RemoveFunnel(ctx context.Context, id string, localVarOptionals *FunnelsApiRemoveFunnelOpts) (FunnelEntity, *http.Response, *string, error) {
	var (
...
@return FunnelEntity
*/
func (a *FunnelsApiService) UpdateFunnel(ctx context.Context, body FunnelEntity, id string) (FunnelEntity, *http.Response, *string, error) {
	var (
