 ...
 * @param requestId The id of the process group representing (a part of) the flow to be analyzed.
@return AnalyzeFlowRequestEntity
*/
func (a *ProcessGroupsApiService) GetAnalyzeFlowRequest(ctx context.Context, id string, requestId string) (AnalyzeFlowRequestEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue AnalyzeFlowRequestEntity
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/process-groups/{id}/flow-analysis-requests/{requestId}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 0 {
			var v AnalyzeFlowRequestEntity
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, &localStringBody, newErr
...
@return AnalyzeFlowRequestEntity
*/
func (a *ProcessGroupsApiService) RemoveAnalyzeFlowRequest(ctx context.Context, id string, requestId string) (AnalyzeFlowRequestEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return AnalyzeFlowRequestEntity
*/
func (a *ProcessGroupsApiService) SubmitAnalyzeFlowRequest(ctx context.Context, id string) (AnalyzeFlowRequestEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/process-groups/{id}/flow-analysis-requests"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
