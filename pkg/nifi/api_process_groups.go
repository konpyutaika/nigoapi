...
func (a *ProcessGroupsApiService) CreateProcessGroup(ctx context.Context, id string, body ProcessGroupEntity, localVarOptionals *ProcessGroupsApiCreateProcessGroupOpts) (ProcessGroupEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod  = strings.ToUpper("Post")
		localVarPostBody    interface{}
		localVarFileName    string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id The process group id.
 * @param body The process group name.
 * @param body2 The process group X position.
 * @param body3 The process group Y position.
 * @param body4 The client id.
