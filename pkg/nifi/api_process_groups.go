...
*/
func (a *ProcessGroupsApiService) CreateControllerService1(ctx context.Context, body ControllerServiceEntity, id string) (ControllerServiceEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *ProcessGroupsApiService) CreateEmptyAllConnectionsRequest(ctx context.Context, id string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *ProcessGroupsApiService) CreateProcessGroup(ctx context.Context, body ProcessGroupEntity, id string, localVarOptionals *ProcessGroupsApiCreateProcessGroupOpts) (ProcessGroupEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
*/
func (a *ProcessGroupsApiService) GetAnalyzeFlowRequest(ctx context.Context, id string, requestId string) (AnalyzeFlowRequestEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *ProcessGroupsApiService) ImportProcessGroup(ctx context.Context, id string, localVarOptionals *ProcessGroupsApiImportProcessGroupOpts) (ProcessGroupEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return AnalyzeFlowRequestEntity
*/
func (a *ProcessGroupsApiService) RemoveAnalyzeFlowRequest(ctx context.Context, id string, requestId string) (AnalyzeFlowRequestEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return DropRequestEntity
*/
func (a *ProcessGroupsApiService) RemoveDropRequest1(ctx context.Context, id string, dropRequestId string) (DropRequestEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return AnalyzeFlowRequestEntity
*/
func (a *ProcessGroupsApiService) SubmitAnalyzeFlowRequest(ctx context.Context, id string) (AnalyzeFlowRequestEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *ProcessGroupsApiService) UploadProcessGroup(ctx context.Context, id string, localVarOptionals *ProcessGroupsApiUploadProcessGroupOpts) (ProcessGroupEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
