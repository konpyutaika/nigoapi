...
*/
func (a *FlowFileQueuesApiService) CreateDropRequest(ctx context.Context, id string) (*http.Response, error) {
	var (
...
*/
func (a *FlowFileQueuesApiService) CreateFlowFileListing(ctx context.Context, id string) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
