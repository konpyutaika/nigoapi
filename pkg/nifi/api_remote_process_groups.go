...
/*
RemoteProcessGroupsApiService Clears bulletins for a remote process group
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body The clear bulletin request.
 * @param id The remote process group id.
@return ClearBulletinsResultEntity
*/
func (a *RemoteProcessGroupsApiService) ClearBulletins6(ctx context.Context, body ClearBulletinsRequestEntity, id string) (ClearBulletinsResultEntity, *http.Response, *string, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/remote-process-groups/{id}/bulletins/clear-requests"
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body The remote process group port configuration details.
 * @param id The remote process group id.
...
/*
RemoteProcessGroupsApiService Updates run status of a remote input port
Note: This endpoint is subject to change as NiFi and it&#x27;s REST API evolve.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body The remote process group port run status details.
 * @param id The remote process group id.
 * @param portId The remote process group port id.
@return RemoteProcessGroupPortEntity
*/
...
/*
RemoteProcessGroupsApiService Updates run status of a remote output port
Note: This endpoint is subject to change as NiFi and it&#x27;s REST API evolve.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body The remote process group port run status details.
 * @param id The remote process group id.
