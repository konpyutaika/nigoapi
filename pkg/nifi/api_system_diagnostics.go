...
func (a *SystemDiagnosticsApiService) GetJmxMetrics(ctx context.Context, localVarOptionals *SystemDiagnosticsApiGetJmxMetricsOpts) (JmxMetricsResultsEntity, *http.Response, error) {
	var (
