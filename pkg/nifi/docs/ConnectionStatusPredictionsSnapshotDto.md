...
**PredictedPercentBytes** | **int32** | Predicted connection percent use regarding queued FlowFiles size and backpressure threshold if configured. | [optional] [default to null]
**PredictedPercentCount** | **int32** | Predicted connection percent use regarding queued FlowFiles count and backpressure threshold if configured. | [optional] [default to null]
