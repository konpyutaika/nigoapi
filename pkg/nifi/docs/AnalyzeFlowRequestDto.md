...
**UpdateSteps** | [**[]AnalyzeFlowRequestUpdateStepDto**](AnalyzeFlowRequestUpdateStepDTO.md) | The steps that are required in order to complete the request, along with the status of each | [optional] [default to null]
**ProcessGroupId** | **string** | The id of the process group representing (a part of) the flow to be analyzed. | [optional] [default to null]
