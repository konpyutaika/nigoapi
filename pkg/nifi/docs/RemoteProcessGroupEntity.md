...
**Component** | [***RemoteProcessGroupDto**](RemoteProcessGroupDTO.md) |  | [optional] [default to null]
**Status** | [***RemoteProcessGroupStatusDto**](RemoteProcessGroupStatusDTO.md) | The status of the remote process group. | [optional] [default to null]
