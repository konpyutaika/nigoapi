...
**Component** | [***ReportingTaskDto**](ReportingTaskDTO.md) |  | [optional] [default to null]
...
**Status** | [***ReportingTaskStatusDto**](ReportingTaskStatusDTO.md) | The status for this ReportingTask. | [optional] [default to null]
