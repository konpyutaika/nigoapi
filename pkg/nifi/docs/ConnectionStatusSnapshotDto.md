...
**PercentUseBytes** | **int32** | Connection percent use regarding queued FlowFiles size and backpressure threshold if configured. | [optional] [default to null]
**PercentUseCount** | **int32** | Connection percent use regarding queued FlowFiles count and backpressure threshold if configured. | [optional] [default to null]
