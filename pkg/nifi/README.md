...
*AuthenticationApi* | [**GetAuthenticationConfiguration**](docs/AuthenticationApi.md#getauthenticationconfiguration) | **Get** /authentication/configuration | Retrieves the authentication configuration details and status information
...
*ConnectorsApi* | [**ApplyConnectorUpdate**](docs/ConnectorsApi.md#applyconnectorupdate) | **Post** /connectors/{id}/apply-update | Applies an update to a connector
*ConnectorsApi* | [**CancelDrain**](docs/ConnectorsApi.md#canceldrain) | **Delete** /connectors/{id}/drain | Cancels the draining of FlowFiles for a connector
*ConnectorsApi* | [**ClearConnectorControllerServiceState**](docs/ConnectorsApi.md#clearconnectorcontrollerservicestate) | **Post** /connectors/{id}/controller-services/{controllerServiceId}/state/clear-requests | Clears the state for a controller service within a connector
*ConnectorsApi* | [**ClearConnectorProcessorState**](docs/ConnectorsApi.md#clearconnectorprocessorstate) | **Post** /connectors/{id}/processors/{processorId}/state/clear-requests | Clears the state for a processor within a connector
*ConnectorsApi* | [**CreateAsset**](docs/ConnectorsApi.md#createasset) | **Post** /connectors/{id}/assets | Creates a new Asset in the given Connector
*ConnectorsApi* | [**CreateConnector**](docs/ConnectorsApi.md#createconnector) | **Post** /connectors | Creates a new connector
*ConnectorsApi* | [**CreatePurgeRequest**](docs/ConnectorsApi.md#createpurgerequest) | **Post** /connectors/{id}/purge-requests | Creates a request to purge the FlowFiles for this connector
*ConnectorsApi* | [**DeleteConfigurationStepVerificationRequest**](docs/ConnectorsApi.md#deleteconfigurationstepverificationrequest) | **Delete** /connectors/{id}/configuration-steps/{configurationStepName}/verify-config/{requestId} | Deletes the Verification Request with the given ID
*ConnectorsApi* | [**DeleteConnector**](docs/ConnectorsApi.md#deleteconnector) | **Delete** /connectors/{id} | Deletes a connector
*ConnectorsApi* | [**DiscardConnectorUpdate**](docs/ConnectorsApi.md#discardconnectorupdate) | **Delete** /connectors/{id}/working-configuration | Discards the working configuration of a connector
*ConnectorsApi* | [**GetAssetContent**](docs/ConnectorsApi.md#getassetcontent) | **Get** /connectors/{id}/assets/{assetId} | Retrieves the content of the asset with the given id for a connector
*ConnectorsApi* | [**GetAssets**](docs/ConnectorsApi.md#getassets) | **Get** /connectors/{id}/assets | Lists the assets that belong to the Connector with the given ID
*ConnectorsApi* | [**GetConfigurationStepVerificationRequest**](docs/ConnectorsApi.md#getconfigurationstepverificationrequest) | **Get** /connectors/{id}/configuration-steps/{configurationStepName}/verify-config/{requestId} | Returns the Verification Request with the given ID
*ConnectorsApi* | [**GetConnector**](docs/ConnectorsApi.md#getconnector) | **Get** /connectors/{id} | Gets a connector
*ConnectorsApi* | [**GetConnectorConfigurationStep**](docs/ConnectorsApi.md#getconnectorconfigurationstep) | **Get** /connectors/{id}/configuration-steps/{configurationStepName} | Gets a specific configuration step by name for a connector
*ConnectorsApi* | [**GetConnectorConfigurationSteps**](docs/ConnectorsApi.md#getconnectorconfigurationsteps) | **Get** /connectors/{id}/configuration-steps | Gets all configuration step names for a connector
*ConnectorsApi* | [**GetConnectorControllerServiceState**](docs/ConnectorsApi.md#getconnectorcontrollerservicestate) | **Get** /connectors/{id}/controller-services/{controllerServiceId}/state | Gets the state for a controller service within a connector
*ConnectorsApi* | [**GetConnectorProcessorState**](docs/ConnectorsApi.md#getconnectorprocessorstate) | **Get** /connectors/{id}/processors/{processorId}/state | Gets the state for a processor within a connector
*ConnectorsApi* | [**GetConnectorPropertyAllowableValues**](docs/ConnectorsApi.md#getconnectorpropertyallowablevalues) | **Get** /connectors/{id}/configuration-steps/{configurationStepName}/property-groups/{propertyGroupName}/properties/{propertyName}/allowable-values | Gets the allowable values for a specific property in a connector&#x27;s configuration step
*ConnectorsApi* | [**GetConnectorStatus**](docs/ConnectorsApi.md#getconnectorstatus) | **Get** /connectors/{id}/status | Gets the status for the process group managed by a connector
*ConnectorsApi* | [**GetControllerServicesFromConnectorProcessGroup**](docs/ConnectorsApi.md#getcontrollerservicesfromconnectorprocessgroup) | **Get** /connectors/{connectorId}/flow/process-groups/{processGroupId}/controller-services | Gets all controller services for a process group within a connector
*ConnectorsApi* | [**GetFlow**](docs/ConnectorsApi.md#getflow) | **Get** /connectors/{connectorId}/flow/process-groups/{processGroupId} | Gets the flow for a process group within a connector
*ConnectorsApi* | [**GetPurgeRequest**](docs/ConnectorsApi.md#getpurgerequest) | **Get** /connectors/{id}/purge-requests/{purge-request-id} | Gets the current status of a purge request for the specified connector
*ConnectorsApi* | [**GetSecrets**](docs/ConnectorsApi.md#getsecrets) | **Get** /connectors/{id}/secrets | Gets all secrets available for configuring a connector
*ConnectorsApi* | [**InitiateDrain**](docs/ConnectorsApi.md#initiatedrain) | **Post** /connectors/{id}/drain | Initiates draining of FlowFiles for a connector
*ConnectorsApi* | [**RemovePurgeRequest**](docs/ConnectorsApi.md#removepurgerequest) | **Delete** /connectors/{id}/purge-requests/{purge-request-id} | Cancels and/or removes a request to purge the FlowFiles for this connector
*ConnectorsApi* | [**SearchConnector**](docs/ConnectorsApi.md#searchconnector) | **Get** /connectors/{id}/search-results | Performs a search against the encapsulated process group of this connector using the specified search term
*ConnectorsApi* | [**SubmitConfigurationStepVerificationRequest**](docs/ConnectorsApi.md#submitconfigurationstepverificationrequest) | **Post** /connectors/{id}/configuration-steps/{configurationStepName}/verify-config | Performs verification of a configuration step for a connector
*ConnectorsApi* | [**UpdateConnector**](docs/ConnectorsApi.md#updateconnector) | **Put** /connectors/{id} | Updates a connector
*ConnectorsApi* | [**UpdateConnectorConfigurationStep**](docs/ConnectorsApi.md#updateconnectorconfigurationstep) | **Put** /connectors/{id}/configuration-steps/{configurationStepName} | Updates a specific configuration step by name for a connector
*ConnectorsApi* | [**UpdateRunStatus**](docs/ConnectorsApi.md#updaterunstatus) | **Put** /connectors/{id}/run-status | Updates run status of a connector
...
*ControllerApi* | [**AnalyzeFlowRegistryClientConfiguration**](docs/ControllerApi.md#analyzeflowregistryclientconfiguration) | **Post** /controller/registry-clients/{id}/config/analysis | Performs analysis of the component&#x27;s configuration, providing information about which attributes are referenced.
*ControllerApi* | [**ClearFlowAnalysisRuleBulletins**](docs/ControllerApi.md#clearflowanalysisrulebulletins) | **Post** /controller/flow-analysis-rules/{id}/bulletins/clear-requests | Clears bulletins for a flow analysis rule
*ControllerApi* | [**ClearParameterProviderBulletins**](docs/ControllerApi.md#clearparameterproviderbulletins) | **Post** /controller/parameter-providers/{id}/bulletins/clear-requests | Clears bulletins for a parameter provider
*ControllerApi* | [**ClearRegistryClientBulletins**](docs/ControllerApi.md#clearregistryclientbulletins) | **Post** /controller/registry-clients/{id}/bulletins/clear-requests | Clears bulletins for a registry client
...
*ControllerApi* | [**DeleteRegistryClientVerificationRequest**](docs/ControllerApi.md#deleteregistryclientverificationrequest) | **Delete** /controller/registry-clients/{id}/config/verification-requests/{requestId} | Deletes the Verification Request with the given ID
...
*ControllerApi* | [**GetRegistryClientTypes**](docs/ControllerApi.md#getregistryclienttypes) | **Get** /controller/registry-types | Retrieves the types of flow registry clients that this NiFi supports
*ControllerApi* | [**GetRegistryClientVerificationRequest**](docs/ControllerApi.md#getregistryclientverificationrequest) | **Get** /controller/registry-clients/{id}/config/verification-requests/{requestId} | Returns the Verification Request with the given ID
...
*ControllerApi* | [**SubmitRegistryClientConfigVerificationRequest**](docs/ControllerApi.md#submitregistryclientconfigverificationrequest) | **Post** /controller/registry-clients/{id}/config/verification-requests | Performs verification of the Registry Client&#x27;s configuration
*ControllerApi* | [**UpdateControllerConfig**](docs/ControllerApi.md#updatecontrollerconfig) | **Put** /controller/config | Updates the configuration for this NiFi
...
*ControllerApi* | [**UpdateRunStatus1**](docs/ControllerApi.md#updaterunstatus1) | **Put** /controller/flow-analysis-rules/{id}/run-status | Updates run status of a flow analysis rule
...
*ControllerServicesApi* | [**ClearBulletins**](docs/ControllerServicesApi.md#clearbulletins) | **Post** /controller-services/{id}/bulletins/clear-requests | Clears bulletins for a controller service
...
*ControllerServicesApi* | [**UpdateRunStatus2**](docs/ControllerServicesApi.md#updaterunstatus2) | **Put** /controller-services/{id}/run-status | Updates run status of a controller service
*CountersApi* | [**GetCounters**](docs/CountersApi.md#getcounters) | **Get** /counters | Gets the current counters for this NiFi
*CountersApi* | [**UpdateAllCounters**](docs/CountersApi.md#updateallcounters) | **Put** /counters | Updates all counters. This will reset all counter values to 0
...
*DataTransferApi* | [**ReceiveFlowFiles**](docs/DataTransferApi.md#receiveflowfiles) | **Post** /data-transfer/input-ports/{portId}/transactions/{transactionId}/flow-files | Transfer FlowFiles to the input port
*DataTransferApi* | [**TransferFlowFiles**](docs/DataTransferApi.md#transferflowfiles) | **Get** /data-transfer/output-ports/{portId}/transactions/{transactionId}/flow-files | Transfer FlowFiles from the output port
...
*FlowApi* | [**ClearBulletins1**](docs/FlowApi.md#clearbulletins1) | **Post** /flow/process-groups/{id}/bulletins/clear-requests | Clears bulletins for components in the specified Process Group.
...
*FlowApi* | [**GetConnectorDefinition**](docs/FlowApi.md#getconnectordefinition) | **Get** /flow/connector-definition/{group}/{artifact}/{version}/{type} | Retrieves the Connector Definition for the specified component type.
*FlowApi* | [**GetConnectorTypes**](docs/FlowApi.md#getconnectortypes) | **Get** /flow/connector-types | Retrieves the types of connectors that this NiFi supports
*FlowApi* | [**GetConnectors**](docs/FlowApi.md#getconnectors) | **Get** /flow/connectors | Gets all connectors
...
*FlowApi* | [**GetFlow1**](docs/FlowApi.md#getflow1) | **Get** /flow/process-groups/{id} | Gets a process group
...
*FlowApi* | [**GetFlowRegistryClientDefinition**](docs/FlowApi.md#getflowregistryclientdefinition) | **Get** /flow/flow-registry-client-definition/{group}/{artifact}/{version}/{type} | Retrieves the Flow Registry Client Definition for the specified component type.
...
*FlowApi* | [**GetListenPorts**](docs/FlowApi.md#getlistenports) | **Get** /flow/listen-ports | Gets all listen ports configured on this NiFi that the current user has access to
...
*FlowApi* | [**GetStepDocumentation**](docs/FlowApi.md#getstepdocumentation) | **Get** /flow/steps/{group}/{artifact}/{version}/{connectorType}/{stepName} | Retrieves the step documentation for the specified Connector configuration step.
...
*InputPortsApi* | [**ClearBulletins2**](docs/InputPortsApi.md#clearbulletins2) | **Post** /input-ports/{id}/bulletins/clear-requests | Clears bulletins for an input port
...
*InputPortsApi* | [**UpdateRunStatus3**](docs/InputPortsApi.md#updaterunstatus3) | **Put** /input-ports/{id}/run-status | Updates run status of an input-port
...
*OutputPortsApi* | [**ClearBulletins3**](docs/OutputPortsApi.md#clearbulletins3) | **Post** /output-ports/{id}/bulletins/clear-requests | Clears bulletins for an output port
...
*OutputPortsApi* | [**UpdateRunStatus4**](docs/OutputPortsApi.md#updaterunstatus4) | **Put** /output-ports/{id}/run-status | Updates run status of an output-port
*ParameterContextsApi* | [**CreateAsset1**](docs/ParameterContextsApi.md#createasset1) | **Post** /parameter-contexts/{contextId}/assets | Creates a new Asset in the given Parameter Context
...
*ParameterContextsApi* | [**GetAssetContent1**](docs/ParameterContextsApi.md#getassetcontent1) | **Get** /parameter-contexts/{contextId}/assets/{assetId} | Retrieves the content of the asset with the given id
*ParameterContextsApi* | [**GetAssets1**](docs/ParameterContextsApi.md#getassets1) | **Get** /parameter-contexts/{contextId}/assets | Lists the assets that belong to the Parameter Context with the given ID.
...
*ParameterProvidersApi* | [**ClearBulletins4**](docs/ParameterProvidersApi.md#clearbulletins4) | **Post** /parameter-providers/{id}/bulletins/clear-requests | Clears bulletins for a parameter provider
...
*ProcessorsApi* | [**ClearBulletins5**](docs/ProcessorsApi.md#clearbulletins5) | **Post** /processors/{id}/bulletins/clear-requests | Clears bulletins for a processor
...
*ProcessorsApi* | [**UpdateRunStatus5**](docs/ProcessorsApi.md#updaterunstatus5) | **Put** /processors/{id}/run-status | Updates run status of a processor
...
*RemoteProcessGroupsApi* | [**ClearBulletins6**](docs/RemoteProcessGroupsApi.md#clearbulletins6) | **Post** /remote-process-groups/{id}/bulletins/clear-requests | Clears bulletins for a remote process group
...
*RemoteProcessGroupsApi* | [**UpdateRemoteProcessGroupInputPortRunStatus**](docs/RemoteProcessGroupsApi.md#updateremoteprocessgroupinputportrunstatus) | **Put** /remote-process-groups/{id}/input-ports/{port-id}/run-status | Updates run status of a remote input port
...
*RemoteProcessGroupsApi* | [**UpdateRemoteProcessGroupOutputPortRunStatus**](docs/RemoteProcessGroupsApi.md#updateremoteprocessgroupoutputportrunstatus) | **Put** /remote-process-groups/{id}/output-ports/{port-id}/run-status | Updates run status of a remote output port
...
*ReportingTasksApi* | [**ClearBulletins7**](docs/ReportingTasksApi.md#clearbulletins7) | **Post** /reporting-tasks/{id}/bulletins/clear-requests | Clears bulletins for a reporting task
...
*ReportingTasksApi* | [**UpdateRunStatus6**](docs/ReportingTasksApi.md#updaterunstatus6) | **Put** /reporting-tasks/{id}/run-status | Updates run status of a reporting task
...
## Documentation For Models
 ...
 - [ClearBulletinsForGroupRequestEntity](docs/ClearBulletinsForGroupRequestEntity.md)
 - [ClearBulletinsForGroupResultsEntity](docs/ClearBulletinsForGroupResultsEntity.md)
 - [ClearBulletinsRequestEntity](docs/ClearBulletinsRequestEntity.md)
 - [ClearBulletinsResultEntity](docs/ClearBulletinsResultEntity.md)
 ...
 - [ConfigurationStepConfigurationDto](docs/ConfigurationStepConfigurationDto.md)
 - [ConfigurationStepDependency](docs/ConfigurationStepDependency.md)
 - [ConfigurationStepDependencyDto](docs/ConfigurationStepDependencyDto.md)
 - [ConfigurationStepEntity](docs/ConfigurationStepEntity.md)
 - [ConfigurationStepNamesEntity](docs/ConfigurationStepNamesEntity.md)
 ...
 - [ConnectorActionDto](docs/ConnectorActionDto.md)
 - [ConnectorConfigurationDto](docs/ConnectorConfigurationDto.md)
 - [ConnectorDefinition](docs/ConnectorDefinition.md)
 - [ConnectorDto](docs/ConnectorDto.md)
 - [ConnectorEntity](docs/ConnectorEntity.md)
 - [ConnectorPropertyAllowableValuesEntity](docs/ConnectorPropertyAllowableValuesEntity.md)
 - [ConnectorPropertyDependency](docs/ConnectorPropertyDependency.md)
 - [ConnectorPropertyDependencyDto](docs/ConnectorPropertyDependencyDto.md)
 - [ConnectorPropertyDescriptor](docs/ConnectorPropertyDescriptor.md)
 - [ConnectorPropertyDescriptorDto](docs/ConnectorPropertyDescriptorDto.md)
 - [ConnectorPropertyGroup](docs/ConnectorPropertyGroup.md)
 - [ConnectorRunStatusEntity](docs/ConnectorRunStatusEntity.md)
 - [ConnectorStatusDto](docs/ConnectorStatusDto.md)
 - [ConnectorStatusSnapshotDto](docs/ConnectorStatusSnapshotDto.md)
 - [ConnectorTypesEntity](docs/ConnectorTypesEntity.md)
 - [ConnectorValueReferenceDto](docs/ConnectorValueReferenceDto.md)
 - [ConnectorsEntity](docs/ConnectorsEntity.md)
 ...
 - [FlowRegistryClientDefinition](docs/FlowRegistryClientDefinition.md)
 ...
 - [ListenPortDto](docs/ListenPortDto.md)
 - [ListenPortsEntity](docs/ListenPortsEntity.md)
 ...
 - [NodeConnectorStatusSnapshotDto](docs/NodeConnectorStatusSnapshotDto.md)
 ...
 - [PropertyGroupConfigurationDto](docs/PropertyGroupConfigurationDto.md)
 - [PropertyHistoryDto](docs/PropertyHistoryDto.md)
 - [PropertyListenPortDefinition](docs/PropertyListenPortDefinition.md)
 ...
 - [SecretsEntity](docs/SecretsEntity.md)
 ...
 - [StepDocumentationEntity](docs/StepDocumentationEntity.md)
 ...
 - [VerifyConnectorConfigStepRequestDto](docs/VerifyConnectorConfigStepRequestDto.md)
 - [VerifyConnectorConfigStepRequestEntity](docs/VerifyConnectorConfigStepRequestEntity.md)
 ...
 - [VersionedComponentState](docs/VersionedComponentState.md)
 ...
 - [VersionedListenPortDefinition](docs/VersionedListenPortDefinition.md)
 - [VersionedNodeState](docs/VersionedNodeState.md)
