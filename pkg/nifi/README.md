...
*ProcessGroupsApi* | [**GetAnalyzeFlowRequest**](docs/ProcessGroupsApi.md#getanalyzeflowrequest) | **Get** /process-groups/{id}/flow-analysis-requests/{requestId} | Gets the current status of a flow analysis request.
...
*ProcessGroupsApi* | [**RemoveAnalyzeFlowRequest**](docs/ProcessGroupsApi.md#removeanalyzeflowrequest) | **Delete** /process-groups/{id}/flow-analysis-requests/{requestId} | Cancels a flow analysis request.
...
*ProcessGroupsApi* | [**SubmitAnalyzeFlowRequest**](docs/ProcessGroupsApi.md#submitanalyzeflowrequest) | **Post** /process-groups/{id}/flow-analysis-requests | Executes a flow analysis for components within a given process group
...
## Documentation For Models
 ...
 - [AnalyzeFlowRequestDto](docs/AnalyzeFlowRequestDto.md)
 - [AnalyzeFlowRequestEntity](docs/AnalyzeFlowRequestEntity.md)
 - [AnalyzeFlowRequestUpdateStepDto](docs/AnalyzeFlowRequestUpdateStepDto.md)
