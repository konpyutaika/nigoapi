...
/*
CountersApiService Updates all counters. This will reset all counter values to 0
Note: This endpoint is subject to change as NiFi and it&#x27;s REST API evolve.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
@return CountersEntity
*/
func (a *CountersApiService) UpdateAllCounters(ctx context.Context) (CountersEntity, *http.Response, *string, error) {
	var (
