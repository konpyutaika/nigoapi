...
/*
OutputPortsApiService Clears bulletins for an output port
...
*/
func (a *OutputPortsApiService) ClearBulletins3(ctx context.Context, body ClearBulletinsRequestEntity, id string) (ClearBulletinsResultEntity, *http.Response, *string, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/output-ports/{id}/bulletins/clear-requests"
...
@return PortEntity
*/
func (a *OutputPortsApiService) UpdateOutputPort(ctx context.Context, body PortEntity, id string) (PortEntity, *http.Response, *string, error) {
	var (
...
*/
func (a *OutputPortsApiService) UpdateRunStatus3(ctx context.Context, body PortRunStatusEntity, id string) (ProcessorEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
