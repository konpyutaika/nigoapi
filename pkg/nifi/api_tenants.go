...
@return UserEntity
*/
func (a *TenantsApiService) UpdateUser(ctx context.Context, body UserEntity, id string) (UserEntity, *http.Response, *string, error) {
	var (
...
@return UserGroupEntity
*/
func (a *TenantsApiService) UpdateUserGroup(ctx context.Context, body UserGroupEntity, id string) (UserGroupEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
