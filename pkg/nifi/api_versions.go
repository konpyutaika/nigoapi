 ...
 * @param optional nil or *VersionsApiDeleteUpdateRequest1Opts - Optional Parameters:
     * @param "DisconnectedNodeAcknowledged" (optional.Bool) -  Acknowledges that this node is disconnected to allow for mutable requests to proceed.
@return VersionedFlowUpdateRequestEntity
*/

type VersionsApiDeleteUpdateRequest1Opts struct {
    DisconnectedNodeAcknowledged optional.Bool
}

func (a *VersionsApiService) DeleteUpdateRequest1(ctx context.Context, id string, localVarOptionals *VersionsApiDeleteUpdateRequest1Opts) (VersionedFlowUpdateRequestEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param body The Version Control Information to revert to.
 * @param id The process group id.
@return VersionedFlowUpdateRequestEntity
*/
func (a *VersionsApiService) InitiateRevertFlowVersion(ctx context.Context, body VersionControlInformationEntity, id string) (VersionedFlowUpdateRequestEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return VersionedFlowUpdateRequestEntity
*/
func (a *VersionsApiService) InitiateVersionControlUpdate(ctx context.Context, body VersionControlInformationEntity, id string) (VersionedFlowUpdateRequestEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return VersionControlInformationEntity
*/
func (a *VersionsApiService) SaveToFlowRegistry(ctx context.Context, body StartVersionControlRequestEntity, id string) (VersionControlInformationEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
...
@return VersionControlInformationEntity
*/
func (a *VersionsApiService) UpdateFlowVersion(ctx context.Context, body VersionedFlowSnapshotEntity, id string) (VersionControlInformationEntity, *http.Response, *string, error) {
	var (
...
@return VersionControlInformationEntity
*/
func (a *VersionsApiService) UpdateVersionControlRequest(ctx context.Context, body VersionControlComponentMappingEntity, id string) (VersionControlInformationEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
