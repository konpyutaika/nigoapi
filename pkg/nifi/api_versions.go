...
func (a *VersionsApiService) DeleteUpdateRequest1(ctx context.Context, id string, localVarOptionals *VersionsApiDeleteUpdateRequest1Opts) (VersionedFlowUpdateRequestEntity, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Delete")
		localVarPostBody   interface{}
		localVarFileName   string
