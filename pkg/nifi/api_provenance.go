 ...
 * @param optional nil or *ProvenanceApiGetProvenanceOpts - Optional Parameters:
     * @param "ClusterNodeId" (optional.String) -  The id of the node where this query exists if clustered.
     * @param "Summarize" (optional.Bool) -  Whether or not to summarize provenance events returned. This property is false by default.
     * @param "IncrementalResults" (optional.Bool) -  Whether or not incremental results are returned. If false, provenance events are only returned once the query completes. This property is true by default.
@return ProvenanceEntity
*/
