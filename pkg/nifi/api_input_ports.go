...
/*
InputPortsApiService Clears bulletins for an input port
...
*/
func (a *InputPortsApiService) ClearBulletins2(ctx context.Context, body ClearBulletinsRequestEntity, id string) (ClearBulletinsResultEntity, *http.Response, *string, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/input-ports/{id}/bulletins/clear-requests"
...
@return PortEntity
*/
func (a *InputPortsApiService) UpdateInputPort(ctx context.Context, body PortEntity, id string) (PortEntity, *http.Response, *string, error) {
	var (
...
*/
func (a *InputPortsApiService) UpdateRunStatus3(ctx context.Context, body PortRunStatusEntity, id string) (ProcessorEntity, *http.Response, *string, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
