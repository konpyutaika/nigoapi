...
**StatusSnapshot** | [***ProcessGroupStatusSnapshotDto**](ProcessGroupStatusSnapshotDTO.md) | The process group status snapshot from the node. | [optional] [default to null]
