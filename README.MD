...
Now available at `nifi-framework-bundle/nifi-framework/nifi-web/nifi-web-api/target/nifi-web-api-2.9.0/docs/rest-api/swagger.json`.
...
Now available at `nifi-registry/nifi-registry-core/nifi-registry-web-api/target/nifi-registry-web-api-2.9.0/docs/rest-api/swagger.json`.
